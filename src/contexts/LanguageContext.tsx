...
const translations = {
  'pt-BR': {
    ...
    'privacy.lastUpdate': 'Última atualização: 20/11/2025',
    'privacy.intro': 'A Wilds Art trata seus dados pessoais com seriedade e transparência, conforme a LGPD (Lei 13.709/2018). Esta Política explica como coletamos, utilizamos e protegemos essas informações.',
    'privacy.controller.title': '1. Controlador e contato',
    'privacy.controller.content': 'Controlador: Wilds Art\nWhatsApp: +55 12 98182-3416\nE-mail: contato@wildsart.com',
    'privacy.data.title': '2. Quais dados coletamos',
    'privacy.data.contact': '2.1 Dados de contato: nome, e-mail, telefone e mensagens enviadas por formulários, WhatsApp ou e-mail.',
    'privacy.data.navigation': '2.2 Dados de navegação: IP, páginas visitadas, data e hora, cookies essenciais e de desempenho.',
    'privacy.data.contract': '2.3 Dados de contratação: informações de orçamento, briefing e execução, dados de pagamento e faturamento (quando aplicável).',
    'privacy.data.content': '2.4 Materiais enviados pelo cliente: logos, imagens, textos e referências do projeto. O cliente declara possuir direitos de uso desses materiais.',
    'privacy.legal.title': '3. Para que usamos os dados',
    'privacy.legal.intro': 'Usamos seus dados para:',
    'privacy.legal.service': 'atendimento e envio de orçamento',
    'privacy.legal.delivery': 'execução dos serviços contratados',
    'privacy.legal.communication': 'comunicação sobre prazos, revisões e suporte',
    'privacy.legal.billing': 'emissão de documentos fiscais',
    'privacy.legal.security': 'segurança e prevenção a fraudes',
    'privacy.legal.marketing': 'contatos pontuais de marketing, com opção de sair a qualquer momento',
    'privacy.sharing.title': '4. Compartilhamento',
    'privacy.sharing.intro': 'Compartilhamos dados apenas quando necessário, com:',
    'privacy.sharing.platforms': 'WhatsApp (comunicação)',
    'privacy.sharing.hosting': 'serviços de hospedagem, e-mail e cloud, analytics',
    'privacy.sharing.payment': 'contabilidade e meios de pagamento (quando usados)',
    'privacy.sharing.note': 'Todos seguem padrões compatíveis com a LGPD.\n\nBase legal: execução de contrato, procedimentos preliminares, obrigação legal, interesse legítimo e/ou consentimento.',
    'privacy.cookies.title': '5. Cookies',
    'privacy.cookies.essential': 'Essenciais – garantem funcionamento do site',
    'privacy.cookies.analytics': 'Desempenho/analytics – ajudam a melhorar a experiência',
    'privacy.cookies.manage': 'O usuário pode desativá-los no navegador.',
    'privacy.retention.title': '6. Retenção',
    'privacy.retention.content': 'Guardamos dados pelo tempo necessário para: atendimento, execução do projeto, obrigações legais e fiscais, e defesa de direitos. Após isso, podem ser eliminados ou anonimizados.',
    'privacy.rights.title': '7. Direitos do titular',
    'privacy.rights.content': 'Você pode solicitar: confirmação e acesso; correção; eliminação ou anonimização; portabilidade; informação sobre compartilhamento; revogação de consentimento; oposição. Basta solicitar por WhatsApp ou e-mail.',
    'privacy.security.title': '8. Segurança',
    'privacy.security.content': 'Utilizamos: HTTPS, controles de acesso, proteção contra scripts maliciosos e backups. Embora nenhum sistema seja infalível, adotamos medidas proporcionais ao risco e notificaremos incidentes conforme a LGPD.',
    'privacy.minors.title': '9. Crianças e adolescentes',
    'privacy.minors.content': 'Nossos serviços são destinados a maiores de idade. Caso identifiquemos dados de menores sem autorização, eles serão removidos.',
    'privacy.changes.title': '10. Alterações',
    'privacy.changes.content': 'Esta Política pode ser ajustada para refletir novas leis, processos ou melhorias. A versão válida é sempre a publicada aqui.',
